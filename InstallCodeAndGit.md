...
|Scalar (Git add-on to manage large-scale repositories)|Off|It's a very feature that runs background processes to manage extremely large repositories. I don't have repos big enough to warrant its use and I don't want the extra background baggage.|
|**Later Pages**|||
